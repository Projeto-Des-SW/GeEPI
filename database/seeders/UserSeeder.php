...
class UserSeeder extends Seeder
{
    ...
    public function run()
    {
        User::factory()->create(['nome'=> 'Administrador', 'email' => 'admin@admin.teste', 'cpf' => null, 'contato' => '87996638997',
                                'password' => Hash::make('admin123'), 'tipo_usuario_id' => 1, 'setor_id' => null]);
